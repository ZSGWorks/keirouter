...
- Harden system tray lifecycle(76568a8)
- **transform:** Strip echoed reasoning_content for non-reasoning providers(ef9cb20)
- **pipeline:** Fall back before committing failed streams(b1da37c)
- **providers:** Classify hidden Qoder and Codex stream failures(5541719)
- **kiro:** Validate event streams before emitting output(7796e23)
- **github:** Honor monthly usage reset window(32c227f)
- **providers:** Sanitize Antigravity and scope Claude beta flags(519787c)
- **oauth:** Refresh expiring accounts proactively in parallel(dad46de)
- **provider-ui:** Harden workspace feedback and keyboard navigation(0d08639)
- **chains-ui:** Make final fallback toggle reliable(13cefdc)
- **chains-ui:** Make chain detail action explicit(6a3dbc3)
- **frontend:** Remove stale xyflow build chunk(7f9ef40)


### Build

- **deps:** Bump react-router and react-router-dom in /frontend(e871ea9)
- **deps:** Bump postcss from 8.5.15 to 8.5.25 in /frontend(b9bd287)


### Documentation

- Update CHANGELOG.md and VERSION for v0.1.28(aa5c12e)


### Features

- **security:** Trust forwarded headers for dashboard session cookie Secure flag(a50e185)
- Add system tray background process support ([#24](https://github.com/mydisha/keirouter/issues/24))(c11df3d)
- Improve Antigravity and gateway reliability(1537e9f)
- **provider-ui:** Add compact provider workspace(37019d5)
- **provider-ui:** Clarify account routing workspace(47494b8)
- **provider-ui:** Simplify routing policy editing(b2aa826)
- **provider-ui:** Focus model catalog workflows(7c5a28f)
- **provider-ui:** Streamline custom model registry(4eca8d0)
- **provider-ui:** Color and align capability metadata(d6895e5)
- **capability:** Enhance capability resolution with service kind and Cloudflare vision support(f541ed4)
- **chains-ui:** Rebuild chain management list(6a48fae)
- **chains-ui:** Add structured chain builder workspace(e8bac32)


### Refactor

- **chains-ui:** Add routing presentation primitives(55055cc)


### Styling

- **provider-ui:** Reduce model card density(4b136df)
- **provider-ui:** Reduce model card density(e4463d1)
